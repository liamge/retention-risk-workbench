...
from src.training import data as training_data
...
def main(args: argparse.Namespace | None = None) -> int:
    ...
    # Keep backward-compatibility with tests/legacy monkeypatching: ensure the dataset
    # builder uses the same symbols exposed by this module.
    training_data.read_table = read_table
    training_data.build_feature_frame = build_feature_frame
    training_data.build_kkbox_feature_frame = build_kkbox_feature_frame
    training_data.split_data = split_data
    ...
    with mlflow.start_run(run_name=run_name):
        mlflow.log_param("data_path", data_source)
